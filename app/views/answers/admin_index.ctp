<div class="answers index">
	...
	<tr>
			...
			<th><?php echo $this->Paginator->sort('answer_value');?></th>
	...
	<tr<?php echo $class;?>>
		...
		<td><?php echo $answer['Answer']['answer_value']; ?>&nbsp;</td>
		<td><?php echo $answer['Answer']['note']; ?>&nbsp;</td>
		<td><?php echo $answer['Answer']['created']; ?>&nbsp;</td>
		<td><?php echo $answer['Answer']['modified']; ?>&nbsp;</td>
		<td class="actions">
