<div class="scores index">
	...
	<tr>
			...
			<th><?php echo $this->Paginator->sort('percentile');?></th>
			<th><?php echo $this->Paginator->sort('positive_score');?></th>
			<th><?php echo $this->Paginator->sort('negative_score');?></th>
	...
	<tr<?php echo $class;?>>
		...
		<td><?php echo $score['Score']['total_points']; ?>&nbsp;</td>
		<td><?php echo $score['Score']['score']; ?>&nbsp;</td>
		<td><?php echo $score['Score']['percentile']; ?>&nbsp;</td>
		<td><?php echo $score['Score']['positive_score']; ?>&nbsp;</td>
		<td><?php echo $score['Score']['negative_score']; ?>&nbsp;</td>
